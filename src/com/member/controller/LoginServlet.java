...
//		}
		...
		if (m != null ) {
			...
			System.out.println("최대유지시간 : " + session.getMaxInactiveInterval());
			RequestDispatcher rd = request.getRequestDispatcher("/views/myinfo/myinfo.jsp");
			...
			request.setAttribute("loc", "/views/login/loginPage.jsp");
			//값을 들고 가야하기때문에 requestDispatcher을 이용해야한다. 
